...
- Citing sources when making technical claims, and changing your mind when the evidence does
...
- Publishing others' private information, such as a physical or email address, without their
  explicit permission
- Posting content that violates the licences under which this project's dependencies are
  distributed
...
and commit messages — and also applies when an individual is officially representing the
community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to the
maintainer through the contact options listed on the
[maintainer's GitHub profile](https://github.com/raksix). All complaints will be reviewed and
